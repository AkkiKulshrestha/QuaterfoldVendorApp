...
import com.quaterfoldvendorapp.data.VersionInfo
import com.quaterfoldvendorapp.ui.SplashActivity
...
fun openUrl(
    ...
    if (isActivityRunning(activity)) {
        ...
        val params = CustomTabColorSchemeParams.Builder()
            .setToolbarColor(activity.resources.getColor(R.color.primary))
            .build()
